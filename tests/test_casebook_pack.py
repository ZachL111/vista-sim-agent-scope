"""Regression checks for the vista-sim-agent-scope casebook."""
...
from casebook.harness import assert_expected, vista_sim_agent_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vista_sim_agent_scope_summary(), assert_expected())
